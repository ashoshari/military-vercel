  ...
  const previewChartOption = useMemo(
    () => ({
      xAxis: {
        ...
        data: previewData.map((d) => d.market.split(" ")[0]),
            ...
            >
              ...
              <AnimatePresence>
                {isViewing && report.status === "ready" && (
                  ...
                  >
                    <div
                      className="border border-t-0 rounded-b-xl p-6"
                      style={{
                    ...
                    >
                        ...
                        {[
                          {
                            ...
                            value: formatN(
                              previewData.reduce((a, b) => a + b.revenue, 0),
                            ),
                            icon: TrendingUp,
                            color: "var(--accent-green)",
                          },
                          {
                            ...
                            value: formatN(
                              previewData.reduce((a, b) => a + b.cost, 0),
                            ),
                            icon: TrendingDown,
                            color: "var(--accent-red)",
                          },
                          {
                            label: "صافي الأرباح",
                            value: formatN(
                              previewData.reduce((a, b) => a + b.profit, 0),
                            ),
                            icon: BarChart3,
                          ...
                          },
                          {
                            label: "الطلبات",
                            value: formatN(
                              previewData.reduce((a, b) => a + b.orders, 0),
                            ),
                            icon: FileBarChart,
                            color: "var(--accent-amber)",
                          },
                      ...
                      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-5">
                        <ChartCard
                          title="الإيرادات والتكلفة والأرباح"
                          subtitle="لكل سوق"
                        ...
                        <ChartCard
                          ...
                          subtitle="الأسواق الخمسة الأولى"
                          option={previewPieOption}
                          height="280px"
                        />
                      </div>
